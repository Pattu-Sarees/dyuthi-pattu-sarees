...
export default function ContactForm() {
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <button type="submit" disabled={sending} className="w-full bg-[#AD1457] hover:bg-[#880E4F] text-white font-semibold py-3 rounded-md transition-colors uppercase tracking-wide text-sm disabled:opacity-50 flex items-center justify-center gap-2">
