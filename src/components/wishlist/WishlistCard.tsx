...
export default function WishlistCard({
  ...
  return (
    <div className="group relative bg-white rounded-lg border border-gray-100 hover:shadow-md transition-all duration-300 flex flex-col">
      {/* Image */}
